...
<?php 
    ...
    <div class="register">
        ...
        <form id="register" method="POST">
            ...
            <label>PICKUP PLACE : </label><br>
            <select type="text" name="place" id="name" placeholder="Enter Your Destination">
            ...
            <input type ="date" name="date" id="datefield" placeholder="ENTER THE DATE FOR BOOKING"><br><br>

            <label>Return date : </label><br>
            <input type ="date" name="rdate" id="rdate" placeholder="Enter The Return Date"><br><br>

            <label>DURATION : </label><br>
            <input type ="number" name="dur" id="dur" min="1" max="30" placeholder="Enter Rent Period (in days)" readonly><br><br>

            <label>PHONE NUMBER : </label><br>
            <input type="tel" name="ph" id="name" maxlength="10" placeholder="Enter Your Phone Number"><br><br>
            
            <label>Drop Off Location : </label><br>
            <select type="text" name="des" id="name" placeholder="Enter Your Destination">
            <option value="" disabled selected>Select Drop Off Place</option>
            <option value="Kothrud">Kothrud</option>
                <option value="Hadapsar">Hadapsar</option>
                <option value="Pimpri">Pimpri</option>
                <option value="Koregaon Park">Koregaon Park</option>
...
<script>
    ...
    // Function to handle change event for booking date
    document.getElementById("datefield").addEventListener("change", function() {
        ...
        document.getElementById("rdate").setAttribute("min", formattedNextDay);
    });

    // Function to handle change event for return date
    document.getElementById("rdate").addEventListener("change", function() {
        var bookingDate = new Date(document.getElementById("datefield").value);
        var returnDate = new Date(this.value);
        var duration = Math.ceil((returnDate - bookingDate) / (1000 * 60 * 60 * 24));
